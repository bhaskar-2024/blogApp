...
export default function Header() {
  ...
  return (
    <Navbar className="border-b-2">
      ...
      >
        <span className="px-2 py-1  rounded-lg bg-green-500 font-mono font-bold text-white dark:text-black">
          IDEAGLOW
        </span>
      ...
      <div className="flex gap-2 md:order-2">
        ...
        {currentUser ? (
          ...
          >
            <Dropdown.Header>
              <span className="block text-sm">@{currentUser ? currentUser.username : "My Blog"}</span>
